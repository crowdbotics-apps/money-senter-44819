"""
Django settings for money_senter_44819 project.
...
ROOT_URLCONF = 'money_senter_44819.urls'
...
WSGI_APPLICATION = 'money_senter_44819.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "money_senter_44819 API",
    "DESCRIPTION": "API documentation for money_senter_44819 App",
    "VERSION": "v1",
}
